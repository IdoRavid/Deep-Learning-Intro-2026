...
plot_metrics(train_losses, test_losses, train_accs, test_accs, "Classifier full dataset")
torch.save(model_full.encoder.state_dict(), "saved_models/encoder_classifier.pth")

# --- 100 examples ---
model_subset = Classifier()
train_losses, test_losses, train_accs, test_accs = train_classifier(model_subset, subset_train_loader)
plot_metrics(train_losses, test_losses, train_accs, test_accs, "Classifier 100 examples")
